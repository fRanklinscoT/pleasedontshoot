...
new class extends Component {
    ...
    public function mount(): void
    {
        ...
        $this->discord_id = Auth::user()->discord_id;
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="alias" id="alias" name="alias" type="text" class="block w-full mt-1"
                required autofocus />

            <x-input-error class="mt-2" :messages="$errors->get('alias')" />
        </div>
        <div>
            <x-input-label for="discord_id" :value="__('Discord ID')" />
            <x-text-input wire:model="discord_id" id="discord_id" name="discord_id" type="text"
                class="block w-full mt-1" required autofocus />

            <x-input-error class="mt-2" :messages="$errors->get('discord_id')" />
        </div>
